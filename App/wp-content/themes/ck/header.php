...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?> xmlns:fb="http://ogp.me/ns/fb#"><!-- http://www.facebook.com/2008/fbml -->
    ...
    <head>
    	<meta name="google-site-verification" content="7g0lc-bbDLdWYGJAKCjwACLeShb5vHmbGETMDBUHwKg" />
        ...
        <meta name="geo.position" content="-34.928726;138.599945" />
        <meta name="ICBM" content="-34.928726, 138.599945" />
		...
		<?php if(is_single() || is_page()){ ?>
			...
			<?php 
				...
				global $post;
				$src  = wp_get_attachment_image_src( get_post_thumbnail_id( $post -> ID ) , 'tsmall' );
					...
					<div class="branding">
						<div class="logo b w_210">
							...
							<?php }else{?>
                                    <h1>
                                        <a href="<?php echo home_url(); ?>" class="hover">
                                            <img src="<?php echo options::get_value( 'styling' , 'logo_url' ) ?>" alt="<?php bloginfo('name'); ?>" />
                                        </a>
                                    </h1>
							<?php } ?>
						</div>
                                        ...
                                        <div class="cosmo-icons"><!--Login logout links-->
                                            <ul class="sf-menu">
                                                <li class="signin">
                                                    ...
                                                    ?>
                                                            <a href="<?php echo get_author_posts_url( $u_id );  ?>"><?php echo get_the_author_meta( 'user_login' , $u_id ) ?><img src="<?php echo get_template_directory_uri() ?>/images/mask.png" class="mask" alt="Mask" /><span><?php echo $role[ get_the_author_meta( 'user_level' , $u_id ) ]; ?></span></a>
                                                    <?php
                                                        }else{
                                                    ?>
                                                            <img src="<?php echo get_template_directory_uri() ?>/images/mask.png" class="mask" alt="Mask" /><span><?php echo $role[ get_the_author_meta( 'user_level' , $u_id ) ]; ?></span>    
                                                    <?php
                                                        }
                                                    ?>
                                                    <ul>
