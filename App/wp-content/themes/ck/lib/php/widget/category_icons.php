...
class widget_category_icons extends WP_Widget {
	...
	/*Constructor*/
		...
		$this->WP_Widget( 'widget_cosmo_category_icons', _TN_ . ' : ' . __( 'Category icons' , 'cosmotheme' ) , $widget_ops );
	}
        ...
        foreach( $categories as $category ){
            ...
            ?>
                <li class="cat-item cat-item-3 cat-item-icon">
                    <a href="<?php echo get_category_link( $category ); ?>" title="View all posts filed under test">
                        <?php
