<?php
    ...
    if( is_user_logged_in () ){
        add_action('wp_ajax_switch' , array( 'post' , 'loop_switch' ) );
    }else{
        add_action('wp_ajax_nopriv_switch' , array( 'post' , 'loop_switch' ) );
    }
    ...
    if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
			'name' => __( 'Footer First', 'cosmotheme' ),
			'id' => 'footer-first',
			'before_widget' => '<aside id="%1$s" class="widget"><div class="%2$s">',
			'after_widget' => '</div></aside>',
        ...
        register_sidebar(array(
			'name' => __( 'Footer Second', 'cosmotheme' ),
			'id' => 'footer-second',
			'before_widget' => '<aside id="%1$s" class="widget"><div class="%2$s">',
			'after_widget' => '</div></aside>',
			'before_title' => '<h5 class="widget-title">',
        ...
        register_sidebar(array(
			'name' => __( 'Footer Third', 'cosmotheme' ),
			'id' => 'footer-third',
			'before_widget' => '<aside id="%1$s" class="widget"><div class="%2$s">',
			'after_widget' => '</div></aside>',
			'before_title' => '<h5 class="widget-title">',
