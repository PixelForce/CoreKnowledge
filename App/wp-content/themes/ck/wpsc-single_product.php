...
<aside id="shopping-cart">
    <?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('shopping cart')) : else : ?>
    <?php endif; ?>
</aside>
...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">			
						...
						<div class="product_description">
								...
								<?php else : ?>
									<?php if(wpsc_product_on_special()) : ?>
										<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>">
                                        	<span class="oldprice" id="old_product_price_<?php echo wpsc_the_product_id(); ?>">
									...
									<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>">
                                    	<span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="currentprice pricedisplay">
                                            ...
                                            <sup> + <?php _e('Postage and Handling', 'wpsc'); ?></sup>
                                        </span>
                                    </p>
									<?php if(wpsc_product_on_special()) : ?>
							...
							<?php if(wpsc_show_fb_like()): ?>
                                <div class="FB_like">
                                    <iframe src="https://www.facebook.com/plugins/like.php?href=<?php echo wpsc_the_product_permalink(); ?>&amp;layout=standard&amp;show_faces=true&amp;width=435&amp;action=like&amp;font=arial&amp;colorscheme=light"
                                    frameborder="0">
                                    </iframe>
                                </div><!--close FB_like-->
                            <?php endif; ?>
							...
							<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
                                        ...
                                        <?php else: ?>
                                        <p class="button blue"><input type="submit" value="<?php _e('Add To Cart', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/></p>
                                        <?php endif; ?>
										...
										<?php if ( wpsc_the_product_additional_description() ) : ?>
                                            <a href="javascript:void(0)" onClick="window.open('<?php echo wpsc_the_product_additional_description(); ?>', '_blank')" class="cosmolink single_additional_description">
                                                <span class="cosmobutton gray demo" type="button" ><span><span><span class="cosmo-ico">&nbsp;</span><?php _e( 'Preview Guide', 'wpsc' ); ?></span></span></span>
                                            </a>
                                        <?php endif; ?>		
			...
			<?php if ( get_post_meta($post->ID, "table_of_contents", true) != "" ) : ?>
                <div class="cosmo-toggle">
                    <div class="open_title">
                        <h3><a class="show">
                        <span class="title_closed visible">Table of Contents</span>
                        <span class="title_open hidden">Table of Contents</span>
                        </a></h3>
                    </div>
