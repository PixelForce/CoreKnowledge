				...
				<div class="b_f_c w_990" style="<?php echo $footer_background_color; ?> <?php echo $background_img; ?>" >
                    ...
                    ?>
                            <div class="b_page clearfix footer-area">
                                ...
                                <div class="b w_210">
                                    <small><?php echo $f4; ?></small>
                                    <!-- Begin MailChimp Signup Form -->
                                    <div id="mc_embed_signup">
										<form action="http://coreknowledge.us4.list-manage.com/subscribe/post?u=2e60d310dc599aa8004a893e0&amp;id=fb2c1cbeb0"
                                        method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
										<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
                                        <div class="clear"><p class="button blue"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></p></div>
                                    </form>
                                    </div>
                                    <!--End mc_embed_signup-->
                                </div>
