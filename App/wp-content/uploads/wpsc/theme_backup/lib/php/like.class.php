<?php
    class like{
        ...
        static function content( $post_id , $st , $return = false ){
            if( $return ){
                ob_start();
                ob_clean();
            }
...
?>
                        <span
                            ...
                            class="ilove set-like voteaction
                                    ...
                                    ?>"
                            >
                            <div class="top_love_<?php echo $post -> ID; ?> top_love"></div>
                            <em><strong class="like-<?php echo $post -> ID; ?>"><?php echo self::count( $post -> ID ); ?></strong></em>
                        </span>
<?php
                    }
                }else{
